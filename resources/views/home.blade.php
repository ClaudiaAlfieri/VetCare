...
@section('content')
        ...
        <div class="container py-4">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <a href="{{ url('/pets') }}" class="btn btn-light btn-lg">
    ...
    <div class="text-center mb-5 mt-5">
        ...
        <p class="text-muted">Alguns dos cuidados disponíveis na VetCare.</p>
    </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title mt-3">Vacinação</h5>
                    <p class="card-text text-muted">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title mt-3">Cuidados</h5>
                    <p class="card-text text-muted">
